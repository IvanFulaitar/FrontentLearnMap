...
<!-- браузер малює сторінку так, ніби ширина екрана ~980px -->`
      ...
      <DemoKeyTakeaway>
        width=device-width прирівнює ширину сторінки до фізичної ширини пристрою в CSS-пікселях, а initial-scale=1.0
        задає стартовий масштаб 100% без авто-зуму. Без цього рядка мобільний рендеринг завжди "прикидається"
        десктопом.
      </DemoKeyTakeaway>
    </div>
  );
