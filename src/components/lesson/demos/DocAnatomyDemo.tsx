...
const PART_EXPLANATION: Record<Part, string> = {
  doctype: "Каже браузеру: \"це сучасний HTML-документ\", і браузер показує сторінку за єдиними, передбачуваними правилами. Без цього рядка браузер може вирішити, що це якийсь старий, нестандартний документ, і почати рахувати навіть базові речі (наприклад, розміри блоків) інакше, ніж очікується.",
  ...
  return (
    <div className={styles.demoStack}>
      ...
      <DemoKeyTakeaway>
        ...
        частин — і щось обов'язково постраждає: як браузер показує сторінку, чи зрозуміє її скрінрідер, чи знайде
        Google, або сама структура сторінки.
      </DemoKeyTakeaway>
    </div>
  );
}
