...
<footer>© 2026 Кав'ярня «Аромат»</footer>`,
  ...
  "Article, section і aside": {
    ...
    learningObjectives: ["Тест \"чи має сенс окремо\" для article.", "Розрізняти section (тематичний блок) від article (самодостатня одиниця).", "Використовувати aside для побічного контенту."],
  ...
  <article>
    ...
    microExercises: [
      { id: "html-article-section-choice", kind: "which-is-more-semantic", prompt: "Що правильніше для окремого поста блогу в стрічці?", options: ["<div class=\"post\">", "<article>"], correctAnswer: "<article>", solution: "Пост блогу самодостатній — його можна опублікувати окремо. Це article." },
    ],
  },
  ...
  "Figure, figcaption, details, summary і dialog": {
    ...
    learningObjectives: ["Підписувати зображення через figure/figcaption.", "Робити розкривний FAQ через details/summary.", "Розуміти базове використання dialog."],
...
<details>
  ...
  "Семантичні кнопки проти посилань": {
    ...
    learningObjectives: ["Обирати a чи button за результатом дії.", "Розуміти, що button за замовчуванням має type=\"submit\" у формі.", "Уникати div/span із onClick замість button."],
