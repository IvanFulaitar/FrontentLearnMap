...
`,
    ...
    quiz: {
      id: "js-object-literals-quiz",
      title: "Швидка перевірка: Обʼєктні літерали",
      questions: [
        {
          id: "js-obj-lit-q1",
          type: "code",
          ...
          options: ["{ price: 50 }", "{ price: \"price\" }", "undefined", "TypeError"],
          correctAnswer: "{ price: 50 }",
          explanation: "Скорочений синтаксис { price } еквівалентний { price: price } — створює властивість price зі значенням змінної price (50).",
        },
        {
          id: "js-obj-lit-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const key = "category";\nconst product = { key: "Книги" };\nconsole.log(product.category);`,
          options: ["Книги", "undefined", "\"key\"", "TypeError"],
          correctAnswer: "undefined",
          explanation: "Без квадратних дужок key: \"Книги\" створює властивість з буквальним іменем \"key\", а не \"category\". product.category — така властивість відсутня.",
        },
        {
          id: "js-obj-lit-q3",
          type: "single",
          question: "Який варіант є скороченим синтаксисом методу обʼєкта?",
          options: ["greet: () => {}", "greet: function() {}", "greet() {}", "const greet = {}"],
          correctAnswer: "greet() {}",
          explanation: "greet() { ... } всередині обʼєктного літерала — скорочений синтаксис методу, еквівалентний greet: function() { ... }.",
        },
        {
          id: "js-obj-lit-q4",
          type: "true-false",
          question: "[dynamicKey]: value обчислює значення змінної dynamicKey і використовує результат як імʼя властивості.",
          options: ["Так", "Ні"],
          correctAnswer: true,
          explanation: "Квадратні дужки в літералі обʼєкта вмикають обчислюваний ключ — імʼям властивості стає РЕЗУЛЬТАТ обчислення виразу всередині дужок.",
        },
        {
          id: "js-obj-lit-q5",
          type: "single",
          question: "Чи можна зберігати функцію як значення властивості обʼєкта?",
          options: [
            "Ні, властивості можуть містити лише примітиви",
            "Так — така властивість зазвичай називається методом обʼєкта",
            "Тільки якщо функція оголошена окремо і присвоєна пізніше",
            "Тільки для стрілкових функцій",
          ],
          correctAnswer: "Так — така властивість зазвичай називається методом обʼєкта",
          explanation: "Властивість обʼєкта може мати будь-яке значення, включно з функцією — вона стає методом обʼєкта, що викликається через obj.methodName().",
        },
      ],
    },
  },
...
`,
    ...
    quiz: {
      id: "js-property-access-quiz",
      title: "Швидка перевірка: Читання та запис властивостей",
      questions: [
        {
          id: "js-prop-q1",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const key = "price";\nconst item = { price: 100 };\nconsole.log(item.key);`,
          options: ["100", "undefined", "\"price\"", "TypeError"],
          correctAnswer: "undefined",
          explanation: "item.key шукає властивість з буквальним іменем \"key\", якої немає — крапкова нотація не обчислює значення змінної key.",
        },
        {
          id: "js-prop-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const userB = { name: "Петро" };\nconsole.log(userB.address?.city);`,
          options: ["undefined", "TypeError", "\"Петро\"", "null"],
          correctAnswer: "undefined",
          explanation: "userB.address дорівнює undefined. ?. перевіряє це ПЕРЕД спробою прочитати .city і безпечно повертає undefined замість кидання помилки.",
        },
        {
          id: "js-prop-q3",
          type: "single",
          question: "У чому різниця між delete obj.prop і obj.prop = undefined?",
          options: [
            "Це те саме, різниці немає",
            "delete видаляє властивість повністю; obj.prop = undefined лише очищає значення, властивість лишається",
            "delete працює лише для масивів",
            "obj.prop = undefined видаляє властивість, а delete лише очищає значення",
          ],
          correctAnswer: "delete видаляє властивість повністю; obj.prop = undefined лише очищає значення, властивість лишається",
          explanation: "delete obj.prop повністю прибирає властивість — вона зникає з Object.keys(). obj.prop = undefined залишає властивість на місці, лише зі значенням undefined.",
        },
        {
          id: "js-prop-q4",
          type: "true-false",
          question: "obj[\"user-name\"] потрібен, бо крапкова нотація obj.user-name сприймає дефіс як оператор віднімання.",
          options: ["Так", "Ні"],
          correctAnswer: true,
          explanation: "У крапковій нотації дефіс інтерпретується як оператор віднімання, тому для ключів з дефісом потрібна дужкова нотація з рядком у лапках.",
        },
        {
          id: "js-prop-q5",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const userWithoutAddress = { name: "Оксана" };\nconsole.log(userWithoutAddress.address.city);`,
          options: ["undefined", "TypeError: Cannot read properties of undefined", "\"Оксана\"", "null"],
          correctAnswer: "TypeError: Cannot read properties of undefined",
          explanation: "userWithoutAddress.address дорівнює undefined. Без ?. спроба прочитати .city з undefined кидає справжній TypeError у рантаймі.",
        },
      ],
    },
  },
...
`,
    ...
    quiz: {
      ...
      title: "Швидка перевірка: Деструктуризація",
      questions: [
        {
          id: "js-destr-q1",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const { b, a } = { a: 1, b: 2 };\nconsole.log(a, b);`,
          options: ["1 2", "2 1", "undefined undefined", "TypeError"],
          correctAnswer: "1 2",
          explanation: "Деструктуризація підбирає значення за іменем ключа, а не за порядком запису в { } — тому a завжди отримує 1, b завжди отримує 2.",
        },
        {
          id: "js-destr-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `function greet(user) {\n  const { name } = user;\n  return "Привіт, " + name;\n}\nconsole.log(greet(undefined));`,
          options: ["Привіт, undefined", "TypeError: Cannot destructure property 'name' of 'undefined'", "Привіт, ", "undefined"],
          correctAnswer: "TypeError: Cannot destructure property 'name' of 'undefined'",
          explanation: "Деструктуризація вимагає, щоб праворуч від = було щось, з чого МОЖНА дістати властивості — undefined для цього не підходить, кидається TypeError.",
        },
        {
          id: "js-destr-q3",
          type: "single",
          question: "Що поверне { count = 10 } = {}?",
          options: ["undefined", "10", "0", "TypeError"],
          correctAnswer: "10",
          explanation: "Обʼєкт {} не має властивості count, тому вона дорівнює undefined — значення за умовчанням 10 застосовується саме для undefined.",
        },
        {
          id: "js-destr-q4",
          type: "true-false",
          question: "Деструктуризація обʼєкта завжди працює за позицією, як і деструктуризація масиву.",
          options: ["Так", "Ні"],
          correctAnswer: false,
          explanation: "Деструктуризація обʼєкта працює за ІМЕНЕМ ключа. Деструктуризація масиву — за позицією. Це принципова різниця між ними.",
        },
        {
          id: "js-destr-q5",
          type: "single",
          question: "Що робить вираз const { id: userId } = response?",
          options: [
            "Створює властивість userId у response",
            "Дістає властивість id з response і зберігає її значення у нову змінну userId",
            "Перейменовує властивість id на userId у самому response",
            "Кидає помилку, бо id і userId — різні імена",
          ],
          correctAnswer: "Дістає властивість id з response і зберігає її значення у нову змінну userId",
          explanation: "{ key: newName } — синтаксис перейменування при деструктуризації: значення властивості id зберігається в локальну змінну з іншим іменем userId, сам response не змінюється.",
        },
      ],
    },
  },
...
`,
    ...
    quiz: {
      id: "js-object-spread-quiz",
      title: "Швидка перевірка: Синтаксис spread",
      questions: [
        {
          id: "js-spread-q1",
          type: "code",
          ...
          options: ["{ x: 1, y: 99 }", "{ x: 1, y: 2 }", "{ y: 99 }", "TypeError"],
          correctAnswer: "{ x: 1, y: 99 }",
          explanation: "b розгортається ПІСЛЯ a, тому його y (99) перезаписує y з a (2); x лишається з a, бо b не має такої властивості.",
        },
        {
          id: "js-spread-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const user = { name: "Іван", settings: { theme: "dark" } };\nconst copy = { ...user };\ncopy.settings.theme = "light";\nconsole.log(user.settings.theme);`,
          options: ["dark", "light", "undefined", "TypeError"],
          correctAnswer: "light",
          explanation: "{ ...user } — поверхнева копія: settings у copy посилається на ТОЙ САМИЙ вкладений обʼєкт, що і в user. Мутація copy.settings.theme змінює й оригінал.",
        },
        {
          id: "js-spread-q3",
          type: "single",
          question: "Який вираз гарантовано поверне обʼєкт з полем count, рівним 5, незалежно від obj.count?",
          options: ["{ count: 5, ...obj }", "{ ...obj, count: 5 }", "{ ...obj }", "obj.count = 5, потім { ...obj }"],
          correctAnswer: "{ ...obj, count: 5 }",
          explanation: "{ ...obj, count: 5 } розгортає obj першим, а потім явно перезаписує count. Якщо спред іде ПІСЛЯ поля, він може перезаписати його назад.",
        },
        {
          id: "js-spread-q4",
          type: "true-false",
          question: "{ ...obj } робить глибоку копію обʼєкта, включно з вкладеними структурами.",
          options: ["Так", "Ні"],
          correctAnswer: false,
          explanation: "Spread робить лише поверхневу копію — вкладені обʼєкти/масиви залишаються тими самими посиланнями, що і в оригіналі.",
        },
        {
          id: "js-spread-q5",
          type: "single",
          question: "Що поверне Object.assign({}, defaults, userOptions), якщо обидва мають властивість fontSize?",
          options: [
            "Значення fontSize з defaults завжди переможе",
            "Значення fontSize з userOptions переможе, бо він переданий останнім",
            "TypeError через конфлікт ключів",
            "Обидва значення зберігаються як масив",
          ],
          correctAnswer: "Значення fontSize з userOptions переможе, бо він переданий останнім",
          explanation: "Object.assign копіює властивості аргументів по черзі зліва направо — останній аргумент з тим самим ключем перезаписує попередній, так само як в { ...a, ...b }.",
        },
      ],
    },
  },
...
`,
    ...
    quiz: {
      id: "js-nested-data-quiz",
      title: "Швидка перевірка: Вкладені дані",
      questions: [
        {
          id: "js-nested-q1",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const data = { user: { orders: [{ id: 1 }, { id: 2 }] } };\nconsole.log(data.user.orders[1].id);`,
          options: ["1", "2", "undefined", "TypeError"],
          correctAnswer: "2",
          explanation: "data.user.orders[1] читає ДРУГЕ замовлення (індекс 1), а .id читає його властивість id, яка дорівнює 2.",
        },
        {
          id: "js-nested-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const config = { theme: { color: "blue" }, version: 1 };\nconst updated = { ...config };\nupdated.theme.color = "red";\nconsole.log(config.theme.color);`,
          options: ["blue", "red", "undefined", "TypeError"],
          correctAnswer: "red",
          explanation: "{ ...config } копіює лише верхній рівень — theme у updated посилається на той самий вкладений обʼєкт, що і в config. Мутація змінює обидва.",
        },
        {
          id: "js-nested-q3",
          type: "single",
          question: "Який вираз безпечно прочитає перший товар першого замовлення, навіть якщо orders може бути відсутнім?",
          options: [
            "user.orders[0].items[0]",
            "user.orders?.[0]?.items[0]",
            "user?.orders[0].items[0]",
            "user.orders?.[0].items?.[0]",
          ],
          correctAnswer: "user.orders?.[0]?.items[0]",
          explanation: "Потрібен ?. і перед індексацією [0] (бо orders може бути undefined), і перед .items (бо orders[0] може бути undefined) — цей варіант захищає обидві точки.",
        },
        {
          id: "js-nested-q4",
          type: "true-false",
          question: "{ ...obj, nested: obj.nested } — це повністю незмінне оновлення на всіх рівнях вкладеності.",
          options: ["Так", "Ні"],
          correctAnswer: false,
          explanation: "Цей вираз копіює зовнішній рівень, але зберігає ТЕ САМЕ посилання на nested замість його копіювання — nested лишається спільним з оригіналом.",
        },
        {
          id: "js-nested-q5",
          type: "single",
          question: "Як правильно незмінно оновити один елемент масиву, що зберігається як властивість обʼєкта?",
          options: [
            "obj.list[i].field = newValue",
            "{ ...obj, list: obj.list.map((item, idx) => idx === i ? { ...item, field: newValue } : item) }",
            "obj.list.splice(i, 1, newValue)",
            "delete obj.list[i]",
          ],
          correctAnswer: "{ ...obj, list: obj.list.map((item, idx) => idx === i ? { ...item, field: newValue } : item) }",
          explanation: "Потрібна комбінація spread для зовнішнього обʼєкта і map для масиву — map створює новий масив, а spread всередині створює новий обʼєкт лише для зміненого елемента.",
        },
      ],
    },
  },
...
`,
    ...
    quiz: {
      id: "js-object-methods-quiz",
      title: "Швидка перевірка: Методи обʼєктів",
      questions: [
        {
          id: "js-obj-methods-q1",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const item = { name: "Ручка", price: 20 };\nconsole.log(Object.keys(item));`,
          options: ["[\"name\", \"price\"]", "[\"Ручка\", 20]", "{ name: \"Ручка\", price: 20 }", "undefined"],
          correctAnswer: "[\"name\", \"price\"]",
          explanation: "Object.keys() повертає масив імен ВЛАСНИХ властивостей обʼєкта, а не їхні значення.",
        },
        {
          id: "js-obj-methods-q2",
          type: "code",
          question: "Що виведе цей код?",
          codeSnippet: `const config = Object.freeze({ limits: { max: 10 } });\nconfig.limits.max = 999;\nconsole.log(config.limits.max);`,
          options: ["10", "999", "undefined", "TypeError"],
          correctAnswer: "999",
          explanation: "Object.freeze() захищає лише властивості ПЕРШОГО рівня. Вкладений обʼєкт limits НЕ заморожений і залишається повністю мутабельним.",
        },
        {
          id: "js-obj-methods-q3",
          type: "single",
          question: "Що повертає Object.entries({ a: 1, b: 2 })?",
          options: ["[\"a\", \"b\"]", "[1, 2]", "[[\"a\", 1], [\"b\", 2]]", "{ a: 1, b: 2 }"],
          correctAnswer: "[[\"a\", 1], [\"b\", 2]]",
          explanation: "Object.entries() повертає масив пар [ключ, значення] для кожної власної властивості.",
        },
        {
          id: "js-obj-methods-q4",
          type: "true-false",
          question: "for...in перебирає лише власні властивості обʼєкта, так само як Object.keys().",
          options: ["Так", "Ні"],
          correctAnswer: false,
          explanation: "for...in перебирає також УСПАДКОВАНІ через прототипний ланцюжок властивості. Object.keys() дає лише власні перелічувані властивості.",
        },
        {
          id: "js-obj-methods-q5",
          type: "single",
          question: "У нестрогому режимі, що станеться при спробі змінити властивість замороженого через Object.freeze() обʼєкта?",
          options: [
            "Кидається TypeError негайно",
            "Зміна тихо ігнорується, без явної помилки",
            "Властивість видаляється",
            "Обʼєкт розморожується автоматично",
          ],
          correctAnswer: "Зміна тихо ігнорується, без явної помилки",
          explanation: "У нестрогому режимі спроба мутації замороженого обʼєкта мовчки ігнорується — це легко не помітити, якщо не перевірити результат явно.",
        },
      ],
    },
  },
...
export const jsObjectsModuleQuiz: QuizData = {
  id: "js-objects-module-quiz",
  title: "Контрольний тест: Обʼєкти",
  questions: [
    {
      id: "js-obj-module-q1",
      type: "code",
      ...
      options: ["Книги", "undefined", "\"key\"", "TypeError"],
      correctAnswer: "undefined",
      explanation: "Без квадратних дужок key: \"Книги\" створює властивість з буквальним іменем \"key\", а не значенням змінної key.",
    },
    {
      id: "js-obj-module-q2",
      type: "code",
      ...
      options: ["undefined", "TypeError", "\"Петро\"", "null"],
      correctAnswer: "undefined",
      explanation: "?. перевіряє, чи address не null/undefined, ПЕРЕД читанням .city — безпечно повертає undefined замість кидання помилки.",
    },
    {
      id: "js-obj-module-q3",
      type: "single",
      question: "За чим деструктуризація обʼєкта підбирає значення?",
      options: ["За позицією зліва направо", "За іменем ключа", "За типом значення", "За алфавітним порядком"],
      correctAnswer: "За іменем ключа",
      explanation: "На відміну від деструктуризації масивів (за позицією), деструктуризація обʼєктів завжди працює за збігом імені ключа.",
    },
    {
      id: "js-obj-module-q4",
      type: "code",
      ...
      options: ["dark", "light", "undefined", "TypeError"],
      correctAnswer: "light",
      explanation: "Spread робить лише поверхневу копію — вкладений обʼєкт settings лишається спільним посиланням, тому мутація видно й в оригіналі.",
    },
    {
      id: "js-obj-module-q5",
      type: "true-false",
      question: "Object.freeze() захищає обʼєкт від мутації на всіх рівнях вкладеності.",
      options: ["Так", "Ні"],
      correctAnswer: false,
      explanation: "Object.freeze() захищає лише ПЕРШИЙ рівень. Вкладені обʼєкти залишаються повністю мутабельними, якщо їх не заморозити окремо.",
    },
    {
      id: "js-obj-module-q6",
      type: "multiple",
      question: "Які з цих тверджень про обʼєкти правильні?",
      options: [
        "{ ...obj } створює лише поверхневу копію",
        "Деструктуризація обʼєкта працює за позицією, як у масивів",
        "Object.entries() повертає масив пар [ключ, значення]",
        "delete obj.prop лише очищає значення, залишаючи властивість",
      ],
      correctAnswer: [
        "{ ...obj } створює лише поверхневу копію",
        "Object.entries() повертає масив пар [ключ, значення]",
      ],
      explanation: "Правильні твердження: поверхневість spread-копії і формат результату Object.entries(). Інші два — поширені помилкові уявлення про деструктуризацію і delete.",
      optionExplanations: {
        "{ ...obj } створює лише поверхневу копію": "Так — вкладені обʼєкти/масиви залишаються спільними посиланнями з оригіналом.",
        "Деструктуризація обʼєкта працює за позицією, як у масивів": "Неправильно — деструктуризація обʼєкта завжди працює за іменем ключа, а не за порядком запису.",
        "Object.entries() повертає масив пар [ключ, значення]": "Так — саме такий формат, зручний для деструктуризації в циклі чи map/filter.",
        "delete obj.prop лише очищає значення, залишаючи властивість": "Неправильно — delete видаляє властивість ПОВНІСТЮ; obj.prop = undefined лише очищає значення.",
      },
    },
  ],
};
